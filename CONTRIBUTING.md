...
Interested in contributing to CC-Camera-Orbit-Animation? Want to report a bug?
...
[2]: https://github.com/ManticoreGamesInc/CC-Camera-Orbit-Animation
...
3. **Pull Request**: After making sure everything passes, commit your changes,
   push your branch to GitHub and send a PR to `ManticoreGamesInc/CC-Camera-Orbit-Animation:main`.
